function [stateArrayCont, stateArrayDisc] = get_stateArrays(zs, as, stateArrayOpt, Options)
...
% dicho ojo. Esta columna de la derecha siempre posee un valor continuo.
    ...
    for i=1:1:num_ojos
        min_laser_region = (i-1)*size_laser_region;
        max_laser_region = i*size_laser_region;
